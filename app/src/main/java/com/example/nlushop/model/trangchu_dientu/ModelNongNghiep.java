...
public class ModelNongNghiep {
    public List<SanPham> LayDanhSachSanPhamNongNghiep(String method, String tenMang, int maloai){
        ...
        hsMaLoaiSP.put("maloaisp", String.valueOf(maloai));
