...
public class FragmentNongNghiep extends Fragment implements ViewNongNghiep {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_nongnghiep, container, false);
        ...
        presenterLogicNongNghiep.LayDanhSachNongNghiep(144);//vì lười nên set cứng cho xong lẹ :v
        presenterLogicNongNghiep.LayDanhSachNongNghiep(145);
        presenterLogicNongNghiep.LayDanhSachNongNghiep(146);
